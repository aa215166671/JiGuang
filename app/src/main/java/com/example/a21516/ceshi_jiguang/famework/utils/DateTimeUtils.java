...
public class DateTimeUtils {
     ...
     * @since 4.5
     */
    public static String getTimeStringAutoShort2(long ms, long ms2, boolean mustIncludeTime)
    {
        String ret = "";

        try
        {
            Date srcDate = new Date(ms);
            GregorianCalendar gcCurrent = new GregorianCalendar();
            gcCurrent.setTime(srcDate);
            ...
            Date srcDate2 = new Date(ms2);
            gcSrc.setTime(srcDate2);
            ...
            // 要额外显示的时间分钟
            String timeExtraStr = (mustIncludeTime?" "+getTimeString(srcDate2, "HH:mm"):"");
            ...
            if(currentYear == srcYear)
            {
                ...
                // 相差时间（单位：毫秒）
                long delta = (srcTimestamp - currentTimestamp );
