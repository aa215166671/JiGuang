...
import com.example.a21516.ceshi_jiguang.activity.PullMsgListActivity;
import com.example.a21516.ceshi_jiguang.activity.UserInfoActivity;
import com.example.a21516.ceshi_jiguang.adapter.FriendsAdapter;
...
import com.example.a21516.ceshi_jiguang.view.EmptyView;
...
public class ContactFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,BaseQuickAdapter.RequestLoadMoreListener{
 ...
 //                               stateListBean = response.body();
   //             Log.e("onStateList=====", response.body().username);
            ...
            @Override
            public void onFailure(Call<UserStateListBean> call, Throwable t) {
                Log.e("onStateList=====","获取失败");
            }
        });
    }
    @Override
