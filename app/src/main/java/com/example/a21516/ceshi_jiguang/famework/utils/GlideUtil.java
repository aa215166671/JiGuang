...
public class GlideUtil {
    ...
    public static void loadImagMessage(Context context,String url,ImageView imageView){
        ...
        Glide.with(context)
                .load(url).apply(imageMessageOptions)
                .into(imageView);
    }
    public static void loadSmallImageMessage(Context context,String url,final ImageView imageView){
        ...
        Glide.with(context)
                .asBitmap().load(url).apply(imageMessageOptions)
                .into(new SimpleTarget<Bitmap>(Target.SIZE_ORIGINAL,Target.SIZE_ORIGINAL) {
                    ...
                    public void onResourceReady(Bitmap bitmap, Transition<? super Bitmap> transition) {
                        ...
                        imageView.setLayoutParams(new RadioGroup.LayoutParams(width,height));
