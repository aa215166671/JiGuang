...
import com.example.a21516.ceshi_jiguang.famework.utils.DisplayWindowUtils;
...
public class MyFloatingActionButton extends FloatingActionButton {
    ...
    private void init(){
        ...
        screenHeigh = DisplayWindowUtils.getWindowHeight((Activity) getContext());
    ...
    public boolean onTouchEvent(MotionEvent event) {
       ...
       switch (event.getAction() & MotionEvent.ACTION_MASK){
           ...
           case MotionEvent.ACTION_MOVE:
               ...
               y = y < statusHeight ? statusHeight : y + getHeight() > screenHeigh ? screenHeigh - getHeight() : y ;
               setX(x);
               setY(y);
